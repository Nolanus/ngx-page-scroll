...
@Component({
    ...
    template: `
        ...
        <nav><a [routerLink]="['Front']">Front Page</a> <a [routerLink]="['Front']" pageScroll href="#anchor2">2nd anchor</a> <a [routerLink]="['About']">About</a> <a [routerLink]="['Contact']">Contact</a></nav>
...
@RouteConfig([
    ...
    {path: '/contact', name: 'Contact', component: LipsumComponent}
])
